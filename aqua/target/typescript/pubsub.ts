...
// Functions
 ...
 export function removeSubscriber(topic: string, config?: {ttl?: number}) : Promise<void>;
 export function removeSubscriber(peer: FluencePeer, topic: string, config?: {ttl?: number}) : Promise<void>;
...
config = args[1];
 ...
 export function subscribeNode(subscriber_node_id: string, topic: string, value: string, service_id: string | null, config?: {ttl?: number}) : Promise<void>;
 export function subscribeNode(peer: FluencePeer, subscriber_node_id: string, topic: string, value: string, service_id: string | null, config?: {ttl?: number}) : Promise<void>;
...
h.on('getDataSrv', 'service_id', () => {return service_id === null ? [] : [service_id];});
 ...
 export function executeOnSubscribers(topic: string, call: (arg0: {peer_id:string;relay_id:string[];service_id:string[];set_by:string;timestamp_created:number;value:string;weight:number}, callParams: CallParams<'arg0'>) => void, config?: {ttl?: number}) : Promise<void>;
 export function executeOnSubscribers(peer: FluencePeer, topic: string, call: (arg0: {peer_id:string;relay_id:string[];service_id:string[];set_by:string;timestamp_created:number;value:string;weight:number}, callParams: CallParams<'arg0'>) => void, config?: {ttl?: number}) : Promise<void>;
...
config = args[2];
 ...
 call(req.args[0], callParams); resp.result = {}
 ...
 export function subscribe(topic: string, value: string, relay_id: string | null, service_id: string | null, config?: {ttl?: number}) : Promise<void>;
 export function subscribe(peer: FluencePeer, topic: string, value: string, relay_id: string | null, service_id: string | null, config?: {ttl?: number}) : Promise<void>;
...
h.on('getDataSrv', 'service_id', () => {return service_id === null ? [] : [service_id];});
 ...
 export function getNeighbours(topic: string, config?: {ttl?: number}) : Promise<string[]>;
 export function getNeighbours(peer: FluencePeer, topic: string, config?: {ttl?: number}) : Promise<string[]>;
...
config = args[1];
 ...
 export function initTopicAndSubscribeNode(subscriber_node_id: string, topic: string, value: string, service_id: string | null, config?: {ttl?: number}) : Promise<void>;
 export function initTopicAndSubscribeNode(peer: FluencePeer, subscriber_node_id: string, topic: string, value: string, service_id: string | null, config?: {ttl?: number}) : Promise<void>;
...
h.on('getDataSrv', 'service_id', () => {return service_id === null ? [] : [service_id];});
 ...
 export function initTopic(topic: string, config?: {ttl?: number}) : Promise<void>;
 export function initTopic(peer: FluencePeer, topic: string, config?: {ttl?: number}) : Promise<void>;
